...
//            shareTxt1.text = percentage
//            print("✅ Share percentage set to: \(percentage)")
//            
//            // Relation
//            if let relationId = data["Relationship"] as? Int {
//                relationID1 = String(relationId)
//            }
//            relationLbl1.text = data["RelationshipValue"] as? String ?? ""
//            
//            // Document Type
...
//            }
//            
//            // ✅ Fix Minor detection - use both API and calculation
...
//            
//            // Use calculated age if it's more accurate
//            nominee1IsMinor = shouldBeMinor ? "Y" : isMinor
//            
//            print("🔍 Nominee 1 - DOB: \(formattedDOB), Age: \(calculatedAge), API Minor: \(isMinor), Final Minor: \(NomineeMinor ?? "N")")
//            
//            DispatchQueue.main.async {
...
//                    self.guardianDobTxt1.text = data["GDOB"] as? String ?? ""
...
//                    
//                    if let guardianRelationId = data["GRelationship"] as? String {
//                        self.guardianRelationID1 = guardianRelationId
//                    }
//                    self.guardianLbl1.text = data["GRelationship"] as? String ?? ""
//                    
...
//            }
//            relationLbl2.text = data["RelationshipValue"] as? String ?? ""
//            
//            // Document Type
//            let docType = data["DocumentType"] as? String ?? ""
...
//            
//            // Use calculated age if it's more accurate
//            nominee2IsMinor = shouldBeMinor ? "Y" : isMinor
//            
//            print("🔍 Nominee 1 - DOB: \(formattedDOB), Age: \(calculatedAge), API Minor: \(isMinor), Final Minor: \(NomineeMinor ?? "N")")
//            
//            DispatchQueue.main.async {
...
//                    self.guardianDobTxt2.text = data["GDOB"] as? String ?? ""
...
//                    }
//                    self.guardianLbl2.text = data["GRelationship"] as? String ?? ""
//                    
//                    if let sameAsNominee = data["SameAsNominee"] as? Int, sameAsNominee == 1 {
...
//            }
//            relationLbl3.text = data["RelationshipValue"] as? String ?? ""
//            
//            // Document Type
//            let docType = data["DocumentType"] as? String ?? ""
...
//            
//            // Use calculated age if it's more accurate
//            nominee3IsMinor = shouldBeMinor ? "Y" : isMinor
//            
//            print("🔍 Nominee 1 - DOB: \(formattedDOB), Age: \(calculatedAge), API Minor: \(isMinor), Final Minor: \(NomineeMinor ?? "N")")
//            
//            DispatchQueue.main.async {
...
//                    self.guardianDobTxt3.text = data["GDOB"] as? String ?? ""
...
//                    }
//                    self.guardianLbl3.text = data["GRelationship"] as? String ?? ""
//                    
//                    if let sameAsNominee = data["SameAsNominee"] as? Int, sameAsNominee == 1 {
        ...
        case 1:
            ...
            DispatchQueue.main.async {
                if self.nominee1IsMinor == "Y" {
                    ...
                    // Fix Guardian Relation - use GRelationship for display, GRelationship for ID
//                    if let guardianRelationValue = data["GRelationship"] as? String {
//                        self.guardianLbl1.text = guardianRelationValue
//                    } else if let guardianRelationId = data["GRelationship"] as? Int {
//                        self.guardianLbl1.text = "\(guardianRelationId)" // Fallback
...
//                    if let guardianRelationValue = data["GRelationship"] as? String {
//                        self.guardianLbl2.text = guardianRelationValue
//                    }
//                    
//                    if let guardianRelationId = data["GRelationship"] as? Int {
...
//                    if let guardianRelationValue = data["GRelationship"] as? String {
//                        self.guardianLbl3.text = guardianRelationValue
//                    }
//                    
//                    if let guardianRelationId = data["GRelationship"] as? Int {
    ...
    func validateNomineeData() -> Bool {
        if nomineeCount >= 1 && !nominee1Stack.isHidden {
            ...
            if !addressSameAsApplicantBtn1.isSelected {
                ...
                if addressTxtSecond1.text?.isEmpty ?? true {
                    showAlert(message: "Please enter Address2")
                    return false
                }
                
                //            if addressTxtThird1.text?.isEmpty ?? true {
                //                showAlert(message: "Please enter Address3")
                //                return false
                //            }
            ...
            if nominee1IsMinor == "Y" {
                ...
                if !nomineeSameAsBtn1.isSelected {
                    ...
                    if guardianAddressTxtSecond1.text?.isEmpty ?? true {
        ...
        if nomineeCount >= 2 && !nominee2Stack.isHidden {
            ...
            if !addressSameAsApplicantBtn2.isSelected {
                ...
                if addressTxtSecond2.text?.isEmpty ?? true {
                    showAlert(message: "Please enter Address2")
                    return false
                }
                
                //            if addressTxtThird2.text?.isEmpty ?? true {
                //                showAlert(message: "Please enter Address3")
                //                return false
                //            }
        ...
        if nomineeCount >= 3 && !nominee3Stack.isHidden {
            ...
            if !addressSameAsApplicantBtn3.isSelected {
                ...
                if addressTxtSecond3.text?.isEmpty ?? true {
                    showAlert(message: "Please enter Address2")
                    return false
                }
                
                //            if addressTxtThird3.text?.isEmpty ?? true {
                //                showAlert(message: "Please enter Address3")
                //                return false
                //            }
...
//extension NomineeVC: UITextFieldDelegate {
//    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
//        // Mobile number validation for nominee fields
//        if textField == nomineeMobile1 || textField == nomineeMobile2 || textField == nomineeMobile3 ||
//           textField == guardianMobileTxt1 || textField == guardianMobileTxt2 || textField == guardianMobileTxt3 {
//
//            // Allow only digits
...
//        }
//
//        // Pincode validation (existing code)
//        if textField == pinCodeTxt1 || textField == pinCodeTxt2 || textField == pinCodeTxt3 ||
//            textField == guardianPinCodeTxt1 || textField == guardianPinCodeTxt2 || textField == guardianPinCodeTxt3 {
//            let currentText = textField.text ?? ""
//            let newLength = currentText.count + string.count - range.length
...
////        switch index {
////        case 1:
////            // Basic Info - Using correct keys from API response
////            nomineeNameTxt1.text = data["NomineeName"] as? String ?? ""
////            nomineeDob1.text = data["DOB"] as? String ?? ""
////            documentId1.text = data["DocumentNumber"] as? String ?? ""
////            nomineeMobile1.text = data["MobileNo"] as? String ?? ""
////            nomineeEmail1.text = data["EmailId"] as? String ?? ""
////            shareTxt1.text = data["Percentage"] as? String ?? ""
////
////            // Relation - API returns both ID and Value
////            if let relationId = data["Relationship"] as? Int {
////                relationID1 = String(relationId)
////            }
////            // Display the relation value (name) in the label
////            relationLbl1.text = data["RelationshipValue"] as? String ?? ""
////
////            // Document Type
////            let docType = data["DocumentType"] as? String ?? ""
...
////            nomineedocumentType1 = docType
////
////            // Address fields - Check if address is same as applicant
////            if let sameAsApplicant = data["SameAsPermanent"] as? Int, sameAsApplicant == 1 {
////                addressSameAsApplicantBtn1.isSelected = true
////                hideNomineeAddress1(true)
////            } else {
...
////            }
////
////            // Guardian fields if minor (NomineeMinor = "Y")
////            let isMinor = data["NomineeMinor"] as? String ?? "N"
////            NomineeMinor = isMinor
////            if isMinor == "Y" {
////                toggleGuardianFields(for: 1, show: true)
////                guardianNameTxt1.text = data["GuardianName"] as? String ?? ""
////                guardianDobTxt1.text = data["GDOB"] as? String ?? ""
////                guardianIdTxt1.text = data["GDocumentNumber"] as? String ?? ""
////                guardianMobileTxt1.text = data["GMobileNo"] as? String ?? ""
////                guardianEmailTxt1.text = data["GEmail"] as? String ?? ""
////
////                // Guardian Relation
////                if let guardianRelationId = data["GRelationship"] as? String {
////                    guardianRelationID1 = guardianRelationId
////                }
////                guardianLbl1.text = data["GRelationship"] as? String ?? ""
////
////                // Guardian Address
////                if let sameAsNominee = data["SameAsNominee"] as? Int, sameAsNominee == 1 {
////                    nomineeSameAsBtn1.isSelected = true
////                    hideGuardianAddress1(true)
////                } else {
////                    guardianAddressTxtFirst1.text = data["GAddress1"] as? String ?? ""
////                    guardianAddressTxtSecond1.text = data["GAddress2"] as? String ?? ""
////                    guardianAddressTxtThird1.text = data["GAddress3"] as? String ?? ""
////                    guardianCityTxt1.text = data["GCity"] as? String ?? ""
////                    guardianStateTxt1.text = data["GState"] as? String ?? ""
////                    guardianPinCodeTxt1.text = data["GPinCode"] as? String ?? ""
////                    hideGuardianAddress1(false)
////                }
////            } else {
////                toggleGuardianFields(for: 1, show: false)
////            }
////
////            // Disable fields if already verified
////            if let documentVerify = data["DocumentNumber_Verify"] as? Int, documentVerify == 1 {
////                disableNomineeFieldsAfterSave(index: 1)
////            }
////
////        case 2:
////            // Similar mapping for Nominee 2
////            nomineeNameTxt2.text = data["NomineeName"] as? String ?? ""
////            nomineeDob2.text = data["DOB"] as? String ?? ""
////            documentId2.text = data["DocumentNumber"] as? String ?? ""
////            nomineeMobile2.text = data["MobileNo"] as? String ?? ""
////            nomineeEmail2.text = data["EmailId"] as? String ?? ""
////            shareTxt2.text = data["Percentage"] as? String ?? ""
////
////            if let relationId = data["Relationship"] as? Int {
////                relationID2 = String(relationId)
////            }
...
////            if isMinor == "Y" {
////                toggleGuardianFields(for: 1, show: true)
////                guardianNameTxt2.text = data["GuardianName"] as? String ?? ""
////                guardianDobTxt2.text = data["GDOB"] as? String ?? ""
////                guardianIdTxt2.text = data["GDocumentNumber"] as? String ?? ""
////                guardianMobileTxt2.text = data["GMobileNo"] as? String ?? ""
////                guardianEmailTxt2.text = data["GEmail"] as? String ?? ""
////
////                // Guardian Relation
////                if let guardianRelationId = data["GRelationship"] as? String {
////                    guardianRelationID2 = guardianRelationId
////                }
////                guardianLbl2.text = data["GRelationship"] as? String ?? ""
////
////                // Guardian Address
////                if let sameAsNominee = data["SameAsNominee"] as? Int, sameAsNominee == 1 {
////                    nomineeSameAsBtn2.isSelected = true
////                    hideGuardianAddress2(true)
////                } else {
////                    guardianAddressTxtFirst2.text = data["GAddress1"] as? String ?? ""
////                    guardianAddressTxtSecond2.text = data["GAddress2"] as? String ?? ""
////                    guardianAddressTxtThird2.text = data["GAddress3"] as? String ?? ""
////                    guardianCityTxt2.text = data["GCity"] as? String ?? ""
////                    guardianStateTxt2.text = data["GState"] as? String ?? ""
////                    guardianPinCodeTxt2.text = data["GPinCode"] as? String ?? ""
////                    hideGuardianAddress2(false)
////                }
////            } else {
////                toggleGuardianFields(for: 1, show: false)
////            }
...
////
////        case 3:
////            // Similar mapping for Nominee 3
////            nomineeNameTxt3.text = data["NomineeName"] as? String ?? ""
////            nomineeDob3.text = data["DOB"] as? String ?? ""
////            documentId3.text = data["DocumentNumber"] as? String ?? ""
////            nomineeMobile3.text = data["MobileNo"] as? String ?? ""
////            nomineeEmail3.text = data["EmailId"] as? String ?? ""
////            shareTxt3.text = data["Percentage"] as? String ?? ""
////
////            if let relationId = data["Relationship"] as? Int {
////                relationID3 = String(relationId)
////            }
...
////            if isMinor == "Y" {
////                toggleGuardianFields(for: 1, show: true)
////                guardianNameTxt3.text = data["GuardianName"] as? String ?? ""
////                guardianDobTxt3.text = data["GDOB"] as? String ?? ""
////                guardianIdTxt3.text = data["GDocumentNumber"] as? String ?? ""
////                guardianMobileTxt3.text = data["GMobileNo"] as? String ?? ""
////                guardianEmailTxt3.text = data["GEmail"] as? String ?? ""
////
////                // Guardian Relation
////                if let guardianRelationId = data["GRelationship"] as? String {
////                    guardianRelationID3 = guardianRelationId
////                }
////                guardianLbl3.text = data["GRelationship"] as? String ?? ""
////
////                // Guardian Address
////                if let sameAsNominee = data["SameAsNominee"] as? Int, sameAsNominee == 1 {
////                    nomineeSameAsBtn3.isSelected = true
////                    hideGuardianAddress3(true)
////                } else {
////                    guardianAddressTxtFirst3.text = data["GAddress1"] as? String ?? ""
////                    guardianAddressTxtSecond3.text = data["GAddress2"] as? String ?? ""
////                    guardianAddressTxtThird3.text = data["GAddress3"] as? String ?? ""
////                    guardianCityTxt3.text = data["GCity"] as? String ?? ""
////                    guardianStateTxt3.text = data["GState"] as? String ?? ""
////                    guardianPinCodeTxt3.text = data["GPinCode"] as? String ?? ""
////                    hideGuardianAddress3(false)
////                }
////            } else {
////                toggleGuardianFields(for: 1, show: false)
////            }
...
//            }
//
//            // ✅ CRITICAL: Check if minor and toggle guardian fields
//            let isMinor = data["NomineeMinor"] as? String ?? "N"
//            NomineeMinor = isMinor
//
//            print("🔍 Nominee 1 - isMinor: \(isMinor)")
//
...
//
//                    // Fill guardian data
//                    self.guardianNameTxt1.text = data["GuardianName"] as? String ?? ""
//                    self.guardianDobTxt1.text = data["GDOB"] as? String ?? ""
//                    self.guardianIdTxt1.text = data["GDocumentNumber"] as? String ?? ""
//                    self.guardianMobileTxt1.text = data["GMobileNo"] as? String ?? ""
//                    self.guardianEmailTxt1.text = data["GEmail"] as? String ?? ""
...
//            }
//
//            // Disable fields if already verified/approved
//            let isVerified = (data["DocumentNumber_Verify"] as? Int == 1)
//            let isApproved = (data["Status"] as? String == "APPROVED")
//
//            if isVerified || isApproved {
...
//
//            let isMinor2 = data["NomineeMinor"] as? String ?? "N"
//            print("🔍 Nominee 2 - isMinor: \(isMinor2)")
//
//            DispatchQueue.main.async {
//                if isMinor2 == "Y" {
//                    print("✅ Showing guardian fields for Nominee 2 (Minor)")
//                    self.toggleGuardianFields(for: 2, show: true)
//                    self.guardianNameTxt2.text = data["GuardianName"] as? String ?? ""
//                    self.guardianDobTxt2.text = data["GDOB"] as? String ?? ""
//                    self.guardianIdTxt2.text = data["GDocumentNumber"] as? String ?? ""
//                    self.guardianMobileTxt2.text = data["GMobileNo"] as? String ?? ""
//                    self.guardianEmailTxt2.text = data["GEmail"] as? String ?? ""
...
//                    }
//                } else {
//                    print("✅ Hiding guardian fields for Nominee 2 (Adult)")
//                    self.toggleGuardianFields(for: 2, show: false)
//                }
//            }
//
...
//
//            let isMinor3 = data["NomineeMinor"] as? String ?? "N"
//            print("🔍 Nominee 3 - isMinor: \(isMinor3)")
//
//            DispatchQueue.main.async {
//                if isMinor3 == "Y" {
//                    print("✅ Showing guardian fields for Nominee 3 (Minor)")
//                    self.toggleGuardianFields(for: 3, show: true)
//                    self.guardianNameTxt3.text = data["GuardianName"] as? String ?? ""
//                    self.guardianDobTxt3.text = data["GDOB"] as? String ?? ""
//                    self.guardianIdTxt3.text = data["GDocumentNumber"] as? String ?? ""
//                    self.guardianMobileTxt3.text = data["GMobileNo"] as? String ?? ""
//                    self.guardianEmailTxt3.text = data["GEmail"] as? String ?? ""
...
//                    }
//                } else {
//                    print("✅ Hiding guardian fields for Nominee 3 (Adult)")
//                    self.toggleGuardianFields(for: 3, show: false)
//                }
//            }
//
...
////        submitBtn.alpha = 0.5
////
////        // Disable all nominee add/remove buttons
////        nomineeBtn1.isEnabled = false
////        nomineeBtn2.isEnabled = false
////        nomineeBtn3.isEnabled = false
////
////        // If you have a "Proceed" button, disable it too
////        submitBtn.isEnabled = false
////    }
//
//    func disableAllControlsAfterSubmission() {
...
//        } else {
//            showAlert(message: "Invalid nominee type.")
//        }
//    }
//
//
...
//    }
//
//    func updateRelationButtonTitle(using id: String, for button: UIButton) {
//        // You'll need to fetch the relation name from your relation list
//        // Since you have the relation list from the API, you can create a mapping
//
//        let relationMapping: [String: String] = [
//            "1": "Spouse",
//            "2": "Son",
//            "3": "Daughter",
//            "4": "Father",
...
//        ]
//
//        if let relationName = relationMapping[id] {
//            print("   → Manually updating button title to: \(relationName)")
//            updateButtonTitle(button, title: relationName)
//        } else {
//            print("   ⚠️ Could not find relation name for ID: \(id)")
//        }
//    }
//
//    func validateNomineeAllocation() {
...
//                parameters["NOMINEE_1Relation"] = relationId
//                parameters["NOMINEE_1Percentage"] = sharePercentage
//                parameters["NOMINEE_1NomineeMinor"] = NomineeMinor ?? "N"
//
//                // Add Nominee 1 address (if not same as applicant)
//                if !addressSameAsApplicantBtn1.isSelected {
//                    parameters["NOMINEE_1Address1"] = addressTxtFirst1.text ?? ""
...
//                if NomineeMinor == "Y" {
//                    parameters["NOMINEE_1GuardianPrefix"] = "Mr."
//                    parameters["NOMINEE_1GuardianName"] = guardianNameTxt1.text ?? ""
//                    parameters["NOMINEE_1GuardianDocumentType"] = guardiandocumentType1 ?? ""
//                    parameters["NOMINEE_1GuardianDocumentExpiryDate"] = ""
//                    parameters["NOMINEE_1GDocumentIDNumberADhar"] = guardianIdTxt1.text ?? ""
//                    parameters["NOMINEE_1GMobileNo"] = guardianMobileTxt1.text ?? ""
//                    parameters["NOMINEE_1GEmail"] = guardianEmailTxt1.text ?? ""
//                    parameters["NOMINEE_1GuardianDOB"] = formatDateForAPI(guardianDobTxt1.text ?? "")
//                    parameters["NOMINEE_1GuardianRelation"] = guardianRelationLbl1.text ?? ""
//                    parameters["NOMINEE_1SameAsNominee"] = nomineeSameAsBtn1.isSelected ? 1 : 0
//
//                    // Add guardian address
//                    if !nomineeSameAsBtn1.isSelected {
...
//                }
//
//                parameters["NOMINEE_2Prefix"] = "Mr."
//                parameters["NOMINEE_2DocumentType"] = nomineedocumentType2 ?? ""
//                parameters["NOMINEE_2DocumentExpiryDate"] = ""
//                parameters["NOMINEE_2NomineePanNoAadhar"] = documentId
//                parameters["NOMINEE_2Name"] = nomineeName
//                parameters["NOMINEE_2MobileNo"] = nomineeMobile2.text ?? ""
//                parameters["NOMINEE_2EmailId"] = nomineeEmail2.text ?? ""
...
//                parameters["NOMINEE_2Relation"] = relationId
//                parameters["NOMINEE_2Percentage"] = sharePercentage
//                parameters["NOMINEE_2NomineeMinor"] = "N"
//
//                if !addressSameAsApplicantBtn2.isSelected {
//                    parameters["NOMINEE_2Address1"] = addressTxtFirst2.text ?? ""
//                    parameters["NOMINEE_2Address2"] = addressTxtSecond2.text ?? ""
...
//                    parameters["NOMINEE_2State"] = stateTxt2.text ?? ""
//                    parameters["NOMINEE_2PinCode"] = pinCodeTxt2.text ?? ""
//                    parameters["NOMINEE_2Country"] = "India"
//                }
//            }
//
//            // MARK: - Nominee 3 Fields
...
//                }
//
//                parameters["NOMINEE_3Prefix"] = "Mr."
//                parameters["NOMINEE_3DocumentType"] = nomineedocumentType3 ?? ""
//                parameters["NOMINEE_3DocumentExpiryDate"] = ""
//                parameters["NOMINEE_3NomineePanNoAadhar"] = documentId
//                parameters["NOMINEE_3Name"] = nomineeName
//                parameters["NOMINEE_3MobileNo"] = nomineeMobile3.text ?? ""
//                parameters["NOMINEE_3EmailId"] = nomineeEmail3.text ?? ""
...
//                parameters["NOMINEE_3Relation"] = relationId
//                parameters["NOMINEE_3Percentage"] = sharePercentage
//                parameters["NOMINEE_3NomineeMinor"] = "N"
//
//                if !addressSameAsApplicantBtn3.isSelected {
//                    parameters["NOMINEE_3Address1"] = addressTxtFirst3.text ?? ""
//                    parameters["NOMINEE_3Address2"] = addressTxtSecond3.text ?? ""
...
//                    parameters["NOMINEE_3State"] = stateTxt3.text ?? ""
//                    parameters["NOMINEE_3PinCode"] = pinCodeTxt3.text ?? ""
//                    parameters["NOMINEE_3Country"] = "India"
//                }
//            }
//
//            print("📤 Full Nominee Submission Parameters: \(parameters)")
