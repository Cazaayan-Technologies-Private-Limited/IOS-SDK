...
class TradingChargesVC: UIViewController {
    ...
    // MARK: - Price Stack View (to hold strikethrough and right price)
    ...
    private func setupViews() {
        ...
        // ✅ Setup Price Stack View with strikethrough and right price
        priceStackView.addArrangedSubview(strikethroughPrice)
        priceStackView.addArrangedSubview(rightPrice)
        
        containerView.addSubview(priceStackView)
        priceStackView.translatesAutoresizingMaskIntoConstraints = false
        
        NSLayoutConstraint.activate([
            priceStackView.topAnchor.constraint(equalTo: rightTitle.bottomAnchor, constant: 10),
            priceStackView.centerXAnchor.constraint(equalTo: rightTitle.centerXAnchor),
        ])
