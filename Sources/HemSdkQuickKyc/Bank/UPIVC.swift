                    ...
                    if let errorCode = jsonResponse["ErrorCode"] as? String {
                        ...
                        case "000000":
                            ...
                            DispatchQueue.main.async {
                                   ...
                                   // Refresh latest status from API
...
//    var clienttrnxid: String?
//    
//    var isWaitingForUPIResult = false
//    
//    override func viewDidLoad() {
//        super.viewDidLoad()
//        
...
//
//        guard isWaitingForUPIResult else {
//            return
//        }
//
//        isWaitingForUPIResult = false
//
//        print("🔥 Checking Penny Drop Status")
//
//        print("TxnId =", reversePennyDropTxnId ?? "nil")
//        print("Id =", reversePennyDropId ?? "nil")
//
//        startUpi()
//    }
//    
...
//                style: .default
//            ) { _ in
//                self.isWaitingForUPIResult = true
//                UIApplication.shared.open(gpayURL)
//            }
//            
//            gpayAction.setValue(
