...
class ApplicationStatusVC: UIViewController, @MainActor AadhaarStackDelegate {
    ...
    @IBOutlet weak var ekraView1: UIButton!
    @IBOutlet weak var aofView1: UIButton!
    @IBOutlet weak var ddpiView1: UIButton!
    ...
    override func viewDidLoad() {
        ...
        dDpiBtn.backgroundColor = .appPrimary
        
        ekraViewBtn.tintColor =  .appPrimary
        aofViewBtn.tintColor = .appPrimary
        ddpiViewBtn.tintColor = .appPrimary
        
        eKraBtn.backgroundColor =  .appPrimary
        aOfBtn.backgroundColor = .appPrimary
        dDpiBtn.backgroundColor = .appPrimary
        
        eKraBtn.layer.cornerRadius = 10
        aOfBtn.layer.cornerRadius = 10
        dDpiBtn.layer.cornerRadius = 10
                ...
                case .success(let jsonResponse):
                    ...
                    if let errorCode = jsonResponse["ErrorCode"] as? String {
                        ...
                        case "000000":
                            ...
                            if self.esignType == "AADHAARSTACK" {
                                DispatchQueue.main.async {
                                    let vc = WebviewAutoSubmitVC()
                                    vc.xmlMsg = self.msg ?? ""
    ...
    func  ViewAllMultiPDF(){
        ...
        CoreDataHelper.fetchAndRemoveFirstToken(entityName: "TokenMobile") { [self] tokenId in
            ...
            apiCall(url: Url, method: "POST", parameters: parameters as [String : Any], view: self.view,loaderText: "please wait...") { result in
                switch result {
                case .success(let jsonResponse):
                    print("ViewAllMultiPDF:-> \(jsonResponse)")
...
//                                        self.ekraID = id
//                                        self.ekraStack.isHidden = (isPDFSign == "1")
//                                        self.eSignLbl1.isHidden = (isPDFSign == "1")
//
//                                    case "E":
//                                        self.aofSign = isPDFSign
//                                        self.aofID = id
//                                        self.aofStack.isHidden = (isPDFSign == "1")
//                                        self.eSignLbl2.isHidden = (isPDFSign == "1")
//
//                                    case "DDPI":
//                                        // ✅ FORCE STATIC
//                                        self.ddpiSign = isPDFSign
