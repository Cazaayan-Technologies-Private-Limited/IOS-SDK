...
extension ApplicationStatic1VC {
    ...
    func SIXTHAPI(userID: String) {
            ...
            CoreDataHelper.fetchAndRemoveFirstToken(entityName: "TokenMobile") { [weak self] tokenId in
                ...
                // API call
                apiCall(url: sixthUrl, method: "POST", parameters: parameters, view: self.view) { [weak self] result in
                    guard let self = self else { return }
                    ...
                    case .success(let jsonResponse):
                        ...
                        // ✅ Extract values safely before any dispatch
                        ...
                        let finalStatus = jsonResponse["FinalStatus"] as? String
                        ...
                        if let errorCode = errorCode {
                            ...
                            case "000000":
                                ...
                                // ✅ Extract UI data before dispatch
...
//                    await self.SIXTHAPI(userID: userId)
//                }
//                print("UserID: \(userId), SessionID: \(sessionID)")
//            } else {
//                print("No UserID or SessionID found.")
...
//            Task {
//                do {
//                    let jsonResponse = try await apiCall(
//                        url: sixthUrl,
//                        method: "POST",
